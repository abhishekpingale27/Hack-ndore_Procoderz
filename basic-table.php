			...
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right">
									...
									<a class="dropdown-item" href="C:\Users\ABHISHEK\Downloads\P5 - Workshop Management.pdf" download="Monthly Report">.pdf</a>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">Scheduled Tasks</h4>
							<!-- <p>Add class <code>.table</code></p> -->
						</div>
						<div class="pull-right">
							<a href="#basic-table" class="btn btn-primary btn-sm scroll-click" rel="content-y"  data-toggle="collapse" role="button"><i class="fa fa-code"></i> Report</a>
						</div>
					</div>
					<table class="table">
						<thead>
						...
						<tbody>
							<tr>
								...
								<!-- <td>Otto</td>
								<td>@mdo</td> -->
								<td><label for="file">Task progress bar :</label>
									<progress id="file" value="32" max="100"> 32% </progress></td>
							</tr>
							<tr>
								<th scope="row">2</th>
								<td>Jacob</td>
								...
								<td>@fat</td> -->
								<td><label for="file">Task progress bar :</label>
									<progress id="file" value="52" max="100"> 52% </progress></td>
							</tr>
							<tr>
								<th scope="row">3</th>
								<td>Larry</td>
								...
								<td>@twitter</td> -->
								<td><label for="file">Task progress bar :</label>
									<progress id="file" value="82" max="100"> 82% </progress></td>
							</tr>
						</tbody>
					</table>
    ...
    <tr>
      <th scope="row">1</th>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">Upload image of Proof (if applicable)</h4>
						</div>
					</div>
